...
inline WindowShape windowFromOrdinal(int ordinal) {
    switch (ordinal) {
        case 0: return WindowShape::Rectangle;
        case 1: return WindowShape::Hamming;
        case 2: return WindowShape::Hann;
        case 3: return WindowShape::Blackman;
        case 4: return WindowShape::Bartlett;
        case 5: return WindowShape::FlatTop;
        default: return WindowShape::Gaussian;
    }
}
