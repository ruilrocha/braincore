 ...
 */
inline void applyUsage(std::vector<Block>& blocks,
                       const std::size_t selected_idx,
...
inline double ssd(const std::vector<double>& a, const std::vector<double>& b,
